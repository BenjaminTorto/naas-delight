...
const PUBLIC_LOCATION = 'Grasmere Road, London';

const Contact = () => {
  const contactInfo = [
    { label: 'Location', value: PUBLIC_LOCATION, icon: '📍' },
    { label: 'Opening Hours', value: 'Tue – Sun: 12PM – 9PM', icon: '🕒' },
    { label: 'Contact', value: '+44 7833 698693', icon: '📞' }
  ];

  return (
    <div style={{ backgroundColor: 'var(--bg-page)', color: 'var(--cream)', minHeight: '100vh', paddingTop: '120px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem' }}>
          
          {/* Left: Branding */}
          <div>
            <div style={{ width: '28px', height: '1px', backgroundColor: 'var(--gold)', marginBottom: '1.5rem' }} />
